export default {
  ...
  "status": {
    ...
    "introPending": "项目介绍待补充。",
    "noDetail": "详情待补充"
  },
  "home": {
    "name": "潘江昀",
    "master": "伦敦艺术大学 - 创意计算机硕士",
    "bachelor": "多伦多大学 - 生物学和免疫学学士",
    "company": "{company} 联合创始人及开发者",
    "intro": "作为创意程序员、开发者和项目经理，我参与并成功推出了一款移动端在线交易应用。在创意编程的学习与实践中，我专注于将神经网络与游戏引擎结合，持续探索游戏行业的发展。"
  },
  "about": {
    "background": "我是潘江昀，也以 Pannic / Nic Pan 的名字创作，是一名创意开发者。我的学习经历从多伦多大学的生物学与免疫学，延伸到伦敦艺术大学的创意计算。如今，我的实践围绕游戏、人工智能与交互艺术展开，通过编程探索现实世界与数字体验之间的联系。",
    "practice": "我尤其关注神经网络与实时交互的结合。在 CatNet 中，我使用 Unity 探索 AI 与增强现实游戏的融合；在 PokemonPad 中，我使用 Three.js、自定义着色器与后期处理，将音乐、三维模型和键盘交互结合成可玩的视觉体验。这些项目涵盖 C#、JavaScript 与 Python，也记录了我在游戏开发、实时图形和创意编程中的探索。",
    "experience": "除了实验性创作，我也参与面向实际用户的产品开发。作为 KaiwuArt 的联合创始人、技术负责人和主程，我负责技术架构与核心功能开发，协调移动应用、微信小程序、网站及云端服务的实现，并与设计师和开发者协作推动产品上线。从交互原型到完整产品，我希望让技术构想成为可以被使用和体验的作品。"
  },
  "menu": {
    "about": "关于",
    "works": "作品",
  ...
  "kaiwu": {
    ...
    "role": "作为 KaiwuArt 的技术负责人和主程，我负责整体技术架构与核心功能开发，统筹 Android/iOS 移动应用、微信小程序、官方网站、云服务与数据库的技术实现，并主导 3D 渲染及加密代币发行与交易功能的开发。我与开发者和设计师紧密协作，推动产品上线，并为后续运营活动提供技术支持。",
    "links": {
      "viewer": "3D 查看器",
      "app": "移动应用",
      "websites": "网站",
